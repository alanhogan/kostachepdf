...
/**
 * Render a Kostache view as a PDF.
 *
 * @author     Woody Gilk <woody.gilk@kohanaphp.com> + Alan Hogan <contact at alan hogan dot com>
 * @copyright  (c) 2009 Woody Gilk
 * @license    MIT
 */
class Kostache_PDF extends Kostache {

	public static function factory($file = NULL, array $data = NULL)
	{
		return new Kostache_PDF($file, $data);
	}
